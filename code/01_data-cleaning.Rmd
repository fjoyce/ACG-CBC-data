...
First, I'll make a data frame to calculate rank abundance where each column is a species (n = `r ncol(birds_ra_df)`) and each row is a "site" (n = `r nrow(birds_ra_df)`, either "leiva" or "murci"). The cells are filled with the total number of observations for each species.
```{r}
